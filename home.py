...
# LOGIN FLOW
if st.session_state.login_clicked and not st.session_state.authenticated:
...
# SHOW LIBRARY BUTTON AFTER LOGIN
if st.session_state.authenticated:
    st.markdown(f"""
    <a href="{sheet_link_data}" target="_blank">
        <button style="padding:10px 20px; font-size:14px;">Open Gamelibrary</button>
    </a>
    """, unsafe_allow_html=True)
